...
public class EvaluationTests
{
    ...
    [Fact]
    public void Evaluator_VariablesDeclaration_Reports_Redeclaration()
    {
        var text = @"
            {
                var x = 10
    ...
    [Fact]
    public void Evaluator_InvokeFunctionArgument_NoInfiniteLoop()
    {
        var text = @"
            print(""Hi""[[=]][)]
        ";
    ...
    [Fact]
    public void Evaluator_AssignmenExpression_Reports_CannotAssign()
    {
        var text = @"
            {
                let x = 10
    ...
    [Fact]
    public void Evaluator_AssignmenExpression_Reports_CannotConvert()
    {
        var text = @"
            {
                var x = 10
    ...
    private void AssertDiagnostics(string text, string diagnosticText)
    {
        ...
        var compilation = new Compilation(syntaxtTree);
