...
internal abstract class Repl
{
    ...
    private sealed class SubmissionView
    {
        ...
        private void Render()
        {
            ...
            foreach (var line in _submissionDocument)
            {
                ...
                Console.ResetColor();
                _lineRenderer(line);
                Console.WriteLine(new string('X', Console.WindowWidth - line.Length - 2));
                lineCount++;
            }
    ...
    private void HandleScape(ObservableCollection<string> document, SubmissionView view)
    {
